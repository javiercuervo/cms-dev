...
.hero-slide-duotone {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(135deg, var(--color-granate) 0%, #8B4744 50%, var(--color-crema) 100%);
...
.hero-slide-shadow {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(to bottom, rgba(95, 50, 47, 0.3) 0%, rgba(95, 50, 47, 0.6) 100%);
}
...
.hero-overlay {
    ...
    width: 100%;
    height: 100%;
    background: linear-gradient(135deg, rgba(95, 50, 47, 0.7) 0%, rgba(110, 70, 67, 0.5) 50%, rgba(95, 50, 47, 0.6) 100%);
    z-index: 3;
}
...
.hero-content h1 {
    ...
    line-height: 1.1;
    margin: 0 0 16px 0;
    text-shadow: 0 2px 20px rgba(95, 50, 47, 0.5);
}
...
.hero-subtitle {
    ...
    line-height: 1.6;
    margin: 0 0 16px 0;
    text-shadow: 0 1px 10px rgba(95, 50, 47, 0.4);
}
...
.prop-section { padding: var(--spacing-section) 20px; }
.prop-container { max-width: var(--max-width); margin: 0 auto; }
.prop-section h2 { font-family: var(--font-titulo); font-size: clamp(32px, 5vw, 48px); font-weight: 600; color: var(--color-granate); text-align: center; margin: 0 0 16px 0; }

.section-que-hacemos { background: var(--color-blanco); }
.section-que-hacemos .prop-container { max-width: 800px; text-align: center; }
.section-que-hacemos .lead { font-size: clamp(18px, 3vw, 22px); line-height: 1.7; margin-bottom: 20px; color: #5F322F; }
.section-que-hacemos .highlight { font-family: var(--font-titulo); font-size: clamp(32px, 6vw, 56px); font-weight: 700; color: var(--color-verde); margin: 32px 0; padding: 24px 0; position: relative; display: inline-block; }
.section-que-hacemos .highlight::after { content: ""; position: absolute; bottom: 16px; left: 50%; transform: translateX(-50%); width: 120px; height: 4px; background: var(--color-granate); border-radius: 2px; }

.section-metodo { background: var(--color-crema); }
.metodo-cards { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; margin: 20px 0 16px; }
...
.pilares-cards { display: grid; grid-template-columns: repeat(3, 1fr); gap: 32px; margin-top: 20px; }
...
<div class="homepage-hero-slider">
    <div class="hero-slider">
        <div class="hero-slide active">
            <div class="hero-slide-image" style="background-image: url('https://staging19.proportione.com/wp-content/uploads/2026/01/IMG_9161-1-2048x1536.jpg');"></div>
            <div class="hero-slide-duotone"></div>
            <div class="hero-slide-shadow"></div>
        </div>
        <div class="hero-slide">
            <div class="hero-slide-image" style="background-image: url('https://staging19.proportione.com/wp-content/uploads/2026/01/IMG_9633-1-2048x1536.jpg');"></div>
            <div class="hero-slide-duotone"></div>
            <div class="hero-slide-shadow"></div>
        </div>
        <div class="hero-slide">
            <div class="hero-slide-image" style="background-image: url('https://staging19.proportione.com/wp-content/uploads/2026/01/IMG_1515-1-2048x1536.jpg');"></div>
            <div class="hero-slide-duotone"></div>
            <div class="hero-slide-shadow"></div>
        </div>
    ...
    <div class="prop-container">
        ...
        <div class="pilares-cards">
            ...
            <div class="pilar-card">
                ...
                <a href="/nosotros/" class="pilar-link">Conozca al equipo →</a>
            </div>
        </div>
    </div>
</section>
