...
/* SECCIONES */
.ns-section { padding: var(--spacing-section) 20px; }
...
/* FILOSOFIA */
.section-filosofia { background: var(--color-blanco); }
.section-filosofia .ns-container { max-width: 800px; text-align: center; }
...
/* COMO TRABAJAMOS */
.section-como { background: var(--color-crema); }
...
/* EQUIPO */
.section-equipo { background: var(--color-blanco); }
.equipo-intro { text-align: center; max-width: 700px; margin: 0 auto 48px; font-size: 18px; line-height: 1.7; }
...
/* DIFERENCIADORES */
.section-diferencia { background: var(--color-crema); }
.diferencia-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 24px; margin-top: 48px; }
.diferencia-item { background: var(--color-blanco); padding: 28px 24px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); }
.diferencia-item h3 { font-family: var(--font-titulo); font-size: 20px; font-weight: 600; color: var(--color-granate); margin: 0 0 8px; padding-left: 24px; position: relative; }
.diferencia-item h3::before { content: ''; position: absolute; left: 0; top: 50%; transform: translateY(-50%); width: 10px; height: 10px; background: var(--color-verde); border-radius: 50%; }
        ...
        <div class="equipo-cards">
            <div class="equipo-card">
                <div class="equipo-foto">
                    <img src="https://staging19.proportione.com/wp-content/uploads/2024/01/Mayte-Tortosa-Cambio-Proportione.png" alt="Mayte Tortosa">
                </div>
                <h3>Mayte Tortosa</h3>
            ...
            <div class="equipo-card">
                <div class="equipo-foto placeholder">
                    <span>JC</span>
                </div>
                <h3>Javier Cuervo</h3>
